 ...
 * @param {string | null} [token_mint]
 * @returns {string}
 */
export function generate_public_transfer(secret_key_bs58, to_address, amount_lamports, token_mint) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ret = wasm.generate_public_transfer(ptr0, len0, ptr1, len1, amount_lamports, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
